...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge:  TextStyle(color: Color(0xFF1E1E24), fontFamily: 'Inter', fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: Color(0xFF1E1E24), fontFamily: 'Inter', fontWeight: FontWeight.w600),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleLarge:  TextStyle(color: Colors.white,   fontFamily: 'Inter', fontWeight: FontWeight.bold),
      titleMedium: TextStyle(color: Colors.white,   fontFamily: 'Inter', fontWeight: FontWeight.w600),
    ),
