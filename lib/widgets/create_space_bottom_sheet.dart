                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final newSpace = SpaceModel(
                        ...
                        title: _nameController.text.isEmpty ? 'New Space' : _nameController.text,
                        ...
                        privacy: _selectedPrivacy == 'Private' ? SpacePrivacy.private : SpacePrivacy.public,
                        lastEditedBy: 'You',
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? const Color(0xFF6B58FF) : const Color(0xFF4B5563),
                  width: isSelected ? 6 : 2, // Inner dot effect via thick border or white center
                ),
              ),
              child: isSelected 
                  ? Center(
                      child: Container(
                        ...
                        height: 12,
                        decoration: const BoxDecoration(
                          color: Color(0xFFD838B5), // Pinkish purple dot from the image inside white border? Actually the image shows a purple circle with white center dot. Let's adjust.
                        ),
                      ),
                    )
                  : null,
